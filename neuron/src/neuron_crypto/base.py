...
the ``Decryptor`` protocol and the ``DecryptResult`` type without the E2EE extra
installed. The actual megolm implementation lives in ``neuron_crypto.megolm``
and is imported only when E2EE is enabled.
"""
